<template>
	<div class="flex items-center justify-center w-full" >  <!-- bg-fixed bg-center bg-cover bg-no-repeat :style="`background-image: url('${src}');`" -->
		<g-image
			:src="src"
			class="absolute z-0 w-full object-cover object-center"
