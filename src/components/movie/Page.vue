		...
		<div class="flex w-full h-full p-2 pt-16">
			...
			<div class="flex-auto md:ml-16 z-10">
				<div class="h-56">
					...
					<movie-title :movie="movie" class="font-bold text-4xl md:text-6xl tracking-loose leading-tight z-10" style="text-shadow: 2px 2px #111;" />
...
<script>
	...
	export default {
		components: {Icons, Score, Classification, MovieTitle, EventLine},
		props: ['movie'],
	}
</script>
